...
from gbgo import encoders
from gbgo import goboard_fast as goboard
from gbgo import kerasutil
from gbgo.agent import Agent
from gbgo.agent.helpers_fast import is_point_an_eye
...
class ValueAgent(Agent):
    ...
    def select_move(self, game_state):
        ...
        moves = []
        board_tensors = []
        board_tensor = self.encoder.encode(game_state.apply_move(game_state))
